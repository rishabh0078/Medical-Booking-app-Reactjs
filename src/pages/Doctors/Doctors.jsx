      ...
      <section className="relative py-12 md:py-24 px-4 bg-gradient-to-r from-white to-orange-100 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-8 md:mb-12">
            ...
            <div className="text-lg md:text-2xl font-semibold text-blue-700 mb-6 md:mb-8">
              Find and Book
            </div>
          </div>
            ...
            {showLocations && createPortal(
              <div
                ...
                style={{
                  minWidth: '280px',
                  maxWidth: '90vw',
                  top: locationRef.current ? locationRef.current.getBoundingClientRect().bottom + 8 : 'auto',
                  left: locationRef.current ? Math.max(16, locationRef.current.getBoundingClientRect().left) : 'auto',
                }}
              >
                {/* Header */}
